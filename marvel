...
SELECT name,
    CASE
        WHEN fighting_Skills > 4 AND alignment = 'Good' THEN "Glad to have it on our side"
        WHEN fighting_Skills >= 4 AND alignment = 'Bad' THEN "It's good to be bad"
        WHEN fighting_Skills < 4 AND alignment = 'Good' THEN "Train harder"
        WHEN fighting_Skills < 4 AND alignment = 'Bad' THEN "Nothing to worry"
        ELSE "Keep them Happy"
